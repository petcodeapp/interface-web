...
>>>>>>> master
  ...
  public async createNewUser (e: string, p: string, pet: string) {
    const defaultPet = {
      "profileUrl": "https://firebasestorage.googleapis.com/v0/b/petcode-b1e6e.appspot.com/o/petProfilePictures%2F123456?alt=media&token=05a87e2e-0d1f-447c-bf1d-9fad6d28cc4f",
      "contacts": [
        {
          "name": {
            "visible": true,
      ...
      "name": "Reggie",
      "additionalInfo": "I like to dig holes. I am a very good boy though. I like to dig holes in the back yard and chase squirrels",
      "reminders": [
        {
          "date": "2020-08-02",
      ...
      "vaccinations": [
        {
          "imageUrl": "https://firebasestorage.googleapis.com/v0/b/petcode-b1e6e.appspot.com/o/vaccineImages%2F123456vaccine0?alt=media&token=18642c4b-2af9-4be7-8cc4-d10437deaad9",
          "name": "Rabies wow",
          "date": {
            "seconds": 1596258000,
            "nanoseconds": 0
        ...
        },
        {
          ...
          "imageUrl": "https://firebasestorage.googleapis.com/v0/b/petcode-b1e6e.appspot.com/o/vaccineImages%2F123456vaccine1?alt=media&token=e775d69b-dd7f-4a62-af34-71a8e495d543"
        },
        {
          "name": "Leptospirosis",
          "imageUrl": null,
    ...
    await auth.createUserWithEmailAndPassword(e,p).then(async user => {
      ...
      await firebase.firestore().collection("users").doc(user.user?.uid).update({
        "name": "John doe",
        "pets": [
          pet
        ]
...
<<<<<<< HEAD
  ...
  public updatePet(pet: any) {
    ...
    firestore().collection("pets").doc(this.petIds[0]).update(pet).then(z => console.log())
