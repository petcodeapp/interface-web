  ...
  return useObserver(() => (
    ...
    >
      ...
      <Box position="relative" paddingBottom={`${50 / 306 * 100}%`}>
        <svg style={{ position: "absolute", top: 0 }} viewBox="0 10 306 101" xmlns="http://www.w3.org/2000/svg" fill={theme.colors.petcode.blue[400]} opacity="0.4">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M-76 0.327148V111C-75.5834 110.523 -75.1655 110.043 -74.7463 109.562C-35.4982 64.5505 15.6852 5.85031 107.567 32.4161C242.033 71.2943 289.514 47.478 313 31.7612V0.327148H-76Z"/>
        </svg>
        <svg style={{ position: "absolute", top: 0 }} viewBox="0 11 306 67" xmlns="http://www.w3.org/2000/svg" fill={theme.colors.petcode.blue[400]}>
          <path fill-rule="evenodd" clip-rule="evenodd" d="M313 0.327637H-76V78.257C-31.9698 40.9295 19.8939 9.49593 114.707 36.3456C221.166 66.493 280.156 37.4736 313 6.57093V0.327637Z"/>
        </svg>
      </Box>
      <Stack
        spacing={12}
