...
const ToggleButton: React.FC<BaseButtonProps & { toggled: boolean }> = ({
  children,
  toggled,
  ...props
}) => (
...
const LeftGroup: React.FC<LeftGroupProps> = observer(({ displayedSection }) => (
  <Flex direction="column" alignItems="start" flexBasis="45%">
    ...
    <Text
      ...
      marginY={5}
    >
      The PetCode tag is so much more than just a tag, it is an evergrowing
      network of features for pet owners.
    </Text>
...
const Comparisons = () => {
    ...
    () => [
      {
        ...
        "PetCode Tag": true,
        "Microchip Implants": false,
        "Standard Tag": true,
      },
      {
        feature: "Immediate Access to Contact Information",
        "PetCode Tag": true,
        "Microchip Implants": false,
        "Standard Tag": true,
      },
      {
        feature: "Ability to Update Contact Information",
        "PetCode Tag": true,
        "Microchip Implants": true,
        "Standard Tag": false,
      },
      {
        feature: "Does Not Require Veterinary Visit",
        "PetCode Tag": true,
        "Microchip Implants": false,
        "Standard Tag": true,
      },
      {
        feature: "Provides Alternative Contact Methods",
        "PetCode Tag": true,
        "Microchip Implants": true,
        "Standard Tag": false,
      },
      {
        feature: "Displays Dietary/Special Needs Info",
        "PetCode Tag": true,
        "Microchip Implants": false,
        "Standard Tag": false,
      },
  ...
  const columns = useMemo(
    () => [
      {
        Header: "",
        Cell: ({ value }: { value: string }) => <TableText>{value}</TableText>,
        accessor: "feature",
        width: 3,
      },
      {
        Header: <TableText>PetCode Tag</TableText>,
        Cell: renderBooleanIcon,
        accessor: "PetCode Tag",
        width: 1,
      },
      {
        Header: <TableText>Microchip Implants</TableText>,
        Cell: renderBooleanIcon,
        accessor: "Microchip Implants",
        width: 1,
      },
      {
        Header: <TableText>Standard Tag</TableText>,
        Cell: renderBooleanIcon,
        accessor: "Standard Tag",
        width: 1,
      },
    ],
    []
...
const WhyPetcodeSection = () => {
  ...
  return useObserver(() => (
    ...
    >
      ...
      {displayedSection.get() == "features" ? <Features /> : <Comparisons />}
    </Flex>
  ));
};
