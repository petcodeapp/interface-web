...
import { Box, Text, ThemeProvider, useTheme } from "@chakra-ui/core";
...
const HowItWorksPage: React.FunctionComponent = () => {
  ...
  return (
    ...
    >
      ...
      >
        <svg
          style={{ position: "absolute", right: 0, top: 0, height: 140 }}
          viewBox="0 0 873 230"
          fill="none"
        ...
        <svg
          style={{ position: "absolute", right: 0, top: 0, height: 200 }}
          viewBox="0 0 984 298"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
