                ...
                <PetInfoCard>
                    {
                        isEditable.get() ? (
                            <PetInfoSelect
                                value={ pet.species }
                                onChange={
                                    action((e: React.ChangeEvent<HTMLSelectElement>) => (pet.species = e.target.value))
                                }
                            >
                ...
                <PetInfoCard>
                    {
                        isEditable.get() ? (
                            <PetInfoInput
                                value={ pet.breed }
                                onChange={
                                    action((e: React.ChangeEvent<HTMLInputElement>) => (pet.breed = e.target.value))
                                }
                            />
                        ): (
                ...
                <PetInfoCard>
                    {
                        isEditable.get() ? (
                            <PetInfoInput
                                value={ pet.color }
                                onChange={
                                    action((e: React.ChangeEvent<HTMLInputElement>) => (pet.color = e.target.value))
                                }
                            />
                        ): (
                ...
                <PetInfoCard>
                    {
                        isEditable.get() ? (
                            <PetInfoInput
                                ...
                                onChange={
                                    action((e: React.ChangeEvent<HTMLInputElement>) => (pet.temperament = e.target.value))
                                }
                            />
                        ): (
                ...
                <PetInfoCard>
                    {
                        isEditable.get() ? (
                            <PetInfoSelect
                                ...
                                onChange={
                                    action((e: React.ChangeEvent<HTMLSelectElement>) => (pet.isServiceAnimal = e.target.value == 'Yes'))
                                }
                            >
                            ...
                            <PetInfoCardText>{ pet.isServiceAnimal ? 'Yes' : 'No' }</PetInfoCardText>
                        )
                    }
