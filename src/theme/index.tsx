...
export default {
    ...
    icons: {
        ...
        template: { path: <path stroke="currentColor" d="M.667 2.083a.917.917 0 0 1 .916-.916h12.834a.917.917 0 0 1 .916.916v1.834a.917.917 0 0 1-.916.916H1.583a.917.917 0 0 1-.916-.916V2.083zm0 7.334a.917.917 0 0 1 .916-.917h5.5A.917.917 0 0 1 8 9.417v5.5a.916.916 0 0 1-.917.916h-5.5a.917.917 0 0 1-.916-.916v-5.5zm11 0a.917.917 0 0 1 .916-.917h1.834a.917.917 0 0 1 .916.917v5.5a.917.917 0 0 1-.916.916h-1.834a.917.917 0 0 1-.916-.916v-5.5z" stroke-linecap="round" stroke-linejoin="round"/> },
        'user-circle': { path: <path stroke="currentColor" d="M2.694 14.82A12.775 12.775 0 0 1 9 13.167c2.292 0 4.443.6 6.306 1.653M11.75 7.667a2.75 2.75 0 1 1-5.5 0 2.75 2.75 0 0 1 5.5 0zm5.5 1.833a8.25 8.25 0 1 1-16.5 0 8.25 8.25 0 0 1 16.5 0z" stroke-linecap="round" stroke-linejoin="round"/> }
    }
};
